...
class SuffixController
{
    ...
    public function getList(Request $request): Json
    {
        try {
            ...
            $whereLike = array();
            if($keyword) {
                $whereLike = array('affix|translation', 'like', '%'.$keyword.'%');
            }

            $data = Db::table('suffix')
    ...
    public function add(Request $request): Json
    {
        try {
            ...
            $result = Db::table('suffix')->insert($data);
    ...
    public function edit(Request $request): Json
    {
        try {
            ...
            $result = Db::table('suffix')->save($data);
    ...
    public function delete(Request $request): Json
    {
        try {
            ...
            // 数据库操作
            $result = Db::table('suffix')->delete($params['id']);
